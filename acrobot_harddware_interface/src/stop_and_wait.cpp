...
int read_data_data(uint16_t* read_output, uint16_t* read_optical_output, LibSerial::SerialPort* serial_port)
{

        // Define the bytes to send
    char start_byte = 0x54;
    uint8_t received_data[2] = { 0x00, 0x00};
    uint8_t received_data_optical[2] = { 0x00, 0x00};
    uint16_t final_received_data = 0x0000;
    uint16_t final_received_optical_data = 0x0000;
    char read_data = 0x00;
    ...
    //READ SEQUENCE
            ...
            serial_port->ReadByte(received_data_optical[0], 1000);
            serial_port->ReadByte(received_data_optical[1], 1000);
            ...
            *read_output = final_received_data;
            ...
            final_received_optical_data = received_data_optical[0];
            final_received_optical_data = final_received_optical_data << 8;
            final_received_optical_data |= received_data_optical[1];
            *read_optical_output = final_received_optical_data;
